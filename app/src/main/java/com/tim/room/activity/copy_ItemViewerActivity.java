...
public class copy_ItemViewerActivity extends AppCompatActivity {
    private static final String TAG = copy_ItemViewerActivity.class.getSimpleName();
...
//                newFragment.show(ft, "slideshow");
                ...
                Intent intent = new Intent(copy_ItemViewerActivity.this, ItemFullScreenViewer.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("items", (Serializable) items);
