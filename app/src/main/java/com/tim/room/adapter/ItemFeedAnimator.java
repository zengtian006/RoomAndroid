 ...
 */
public class ItemFeedAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
            lastAddAnimatedItem++;
            runEnterAnimation((ItemFeedAdapter.ViewHolder) viewHolder);
            return false;
        }
    ...
    private void runEnterAnimation(final ItemFeedAdapter.ViewHolder holder) {
        final int screenHeight = CommonUtil.getScreenHeight(holder.itemView.getContext());
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            ItemFeedAdapter.ViewHolder holder = (ItemFeedAdapter.ViewHolder) newHolder;

            animateHeartButton(holder, holder.getFeedItem().isLiked());
            updateLikesCounter(holder, holder.getFeedItem().getLikesCount());
            if (ItemFeedAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final ItemFeedAdapter.ViewHolder holder, boolean isLiked) {
        if (isLiked) {
    ...
    private void updateLikesCounter(ItemFeedAdapter.ViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final ItemFeedAdapter.ViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(ItemFeedAdapter.ViewHolder holder) {
    ...
    private void resetLikeAnimationState(ItemFeedAdapter.ViewHolder holder) {
