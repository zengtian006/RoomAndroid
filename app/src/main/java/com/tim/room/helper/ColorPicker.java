...
import com.tim.room.adapter.ColorViewAdapter;
import com.tim.room.model.ColorPal;
...
public class ColorPicker {
    ...
    public ColorPicker(Context context) {
        dialogViewLayout = LayoutInflater.from(context).inflate(R.layout.activity_item_filter, null, false);
